...
//      ※ ラウンドは Sound Ventures / True Ventures / Offline / Adjacent / Tekton / Drysdale / Vaynerfund 等の "シンジケート" と各報道は表現。
//        特定のリード投資家を明言したソースは確認できなかったため "主導/led by" とは書かず "参加/シンジケート" に留める。
...
// 数値メモ:
//   - 収益は本人申告の年換算ラン・レート。告知文「approaching $10M ARR」+「5ヶ月で約$10M ARR / 約7,600社が稼働 / M2継続85%」(複数報道)で照合。報道は "supporting ~7,600 businesses" 等で、全社が有料との明示はないため "有料" とは断定しない。
...
export const polsia = {
  ...
  summary: {
    ja: "元CloudKitchens幹部のBen Ceraが、たった1人＋AIで立ち上げたAI企業運営プラットフォーム。9体のAIエージェントが事業を24時間自走させ、launchから数ヶ月でARR約$10M(本人公表のラン・レート)・約7,600社が稼働に到達。従業員ゼロのまま$30Mを$250Mの評価で調達した。",
    en: "An AI company-operations platform built by ex-CloudKitchens operator Ben Cera with one human + AI. Nine agents run businesses 24/7; within months it reached ~$10M ARR (founder-reported run-rate) and ~7,600 businesses on the platform — and raised $30M at a $250M valuation with zero employees.",
  },

  revenueRaw: {
    ja: "従業員ゼロ・創業者1人でARR約$10M(本人公表の年換算ラン・レート)、約7,600社が稼働、2ヶ月目継続率85%。課金は$49/月＋売上の20%。2026年5月にSound Ventures らのシンジケートで$30Mを$250Mの評価額で調達(調達作業の大部分もAIが実行)。※ARRは本人申告のラン・レートで外部から懐疑もある。",
    en: "Zero employees, one founder: ~$10M ARR (founder-reported annual run-rate), ~7,600 businesses on the platform, 85% month-two retention. Pricing is $49/mo + 20% of revenue. Raised $30M at a $250M valuation in May 2026 from a syndicate including Sound Ventures and True Ventures — with the AI running most of the raise itself. (ARR is a founder-reported run-rate and has drawn skepticism.)",
  },
  ...
  failureNote: {
    ja: "Polsiaの数字には正当な懐疑がある。ARRは“実現済みの売上”ではなく本人申告のラン・レートで、しかも顧客の売上×20%の集計を含むため、初期顧客が定着しなければ見かけのARRは膨らんでも実態は伴わない。$250Mの評価額は過熱との指摘があり、Mixergyは「詐欺か?」と本人へ直撃した。一方で約7,600社が稼働・2ヶ月目継続85%・著名VCの参加という実体シグナルも確かにある。結論は二者択一ではなく、『数字を到達ラン・レートとして割り引きつつ、再現すべき仕組み(エージェント分業・成果連動課金・調達をデモ化する発想)だけを抜き出す』ことだ。",
